...
export function MediaPipeDetail({ onBack }: MediaPipeDetailProps) {
  return (
    <div className="min-h-screen bg-transparent relative overflow-hidden">
      ...
      {/* Glowing orbs */}
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-orange-500 rounded-full blur-[150px] opacity-20" />
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-yellow-400 rounded-full blur-[150px] opacity-20" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center justify-center w-32 h-32 mb-8 rounded-3xl bg-gradient-to-br from-orange-500 to-amber-500 shadow-[0_0_50px_rgba(249,115,22,0.5)]"
          >
          ...
          >
            ...
            <span className="text-sm text-yellow-400 font-semibold">Google's ML Solution</span>
          </motion.div>
              ...
              <div className="group relative h-full p-6 rounded-2xl bg-gradient-to-br from-black/50 to-black/70 border-2 border-orange-500/50 backdrop-blur-sm hover:border-yellow-400/50 transition-all duration-300 hover:shadow-[0_0_50px_rgba(249,115,22,0.3)]">
                ...
                <ResponsiveContainer width="100%" height={200}>
                  <AreaChart data={performanceData}>
                    ...
                    />
                    <Area type="monotone" dataKey="accuracy" stroke="#f97316" strokeWidth={2} fillOpacity={1} fill="url(#colorAccuracy)" />
                  </AreaChart>
                </ResponsiveContainer>
              ...
              <div className="group relative h-full p-6 rounded-2xl bg-gradient-to-br from-black/50 to-black/70 border-2 border-orange-500/50 backdrop-blur-sm hover:border-yellow-400/50 transition-all duration-300 hover:shadow-[0_0_50px_rgba(249,115,22,0.3)]">
                ...
                <ResponsiveContainer width="100%" height={200}>
                  <LineChart data={latencyData}>
                    ...
                    />
                    <Line type="monotone" dataKey="latency" stroke="#fbbf24" strokeWidth={3} dot={{ fill: '#fbbf24', r: 4 }} />
                  </LineChart>
                </ResponsiveContainer>
                
                <div className="mt-4 text-center">
                  <div className="text-3xl font-bold text-yellow-400">37ms</div>
        ...
        >
          <div className="relative p-10 rounded-2xl bg-gradient-to-br from-black/50 to-black/70 border-2 border-orange-500/50 shadow-[0_0_50px_rgba(249,115,22,0.3)]">
            ...
            <div className="max-w-4xl mx-auto space-y-6 text-gray-300 text-lg leading-relaxed">
              <p>
                MediaPipe serves as the <span className="text-yellow-400 font-semibold">foundational layer</span> of Qyran's 
              ...
              <p>
                By running entirely <span className="text-orange-400 font-semibold">on-device</span>, MediaPipe ensures that 
              ...
              <p>
                ...
                an industry-leading <span className="text-yellow-400 font-semibold">98.7% accuracy rate</span> across 
