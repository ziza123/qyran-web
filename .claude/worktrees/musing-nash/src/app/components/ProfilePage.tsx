...
export function ProfilePage({ onBack }: ProfilePageProps) {
  ...
  return (
    <div className="size-full bg-[#0F172A] overflow-x-hidden min-h-screen" style={{ fontFamily: '"Space Grotesk", sans-serif' }}>
      {/* Background effects */}
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-1/4 -left-32 w-96 h-96 rounded-full bg-[#4F46E5]/5 blur-[120px]" />
        <div className="absolute bottom-1/4 -right-32 w-96 h-96 rounded-full bg-[#FDE047]/5 blur-[120px]" />
      </div>
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-4 pt-20 pb-12">
        ...
        >
          ...
          <div className="relative p-8 rounded-2xl bg-white/[0.03] backdrop-blur-xl border border-white/10 overflow-hidden">
            ...
            <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-[#4F46E5]/20 via-transparent to-[#FDE047]/10 pointer-events-none" />
            ...
            <div className="relative flex flex-col items-center text-center space-y-4">
              ...
              <motion.div
                ...
                className="w-24 h-24 rounded-full bg-gradient-to-br from-[#4F46E5] to-[#6366F1] flex items-center justify-center shadow-[0_0_40px_rgba(79,70,229,0.3)] border-2 border-[#4F46E5]/50"
              >
          ...
          <div className="space-y-3">
            ...
            >
              <div className="w-10 h-10 rounded-lg bg-[#4F46E5]/10 flex items-center justify-center border border-[#4F46E5]/20">
