...
export function TensorFlowDetail({ onBack }: TensorFlowDetailProps) {
  return (
    <div className="min-h-screen bg-[#0F172A] relative overflow-hidden">
      ...
      {/* Glowing orbs */}
      <div className="absolute top-0 right-1/4 w-96 h-96 bg-[#4F46E5] rounded-full blur-[150px] opacity-20" />
      <div className="absolute bottom-0 left-1/4 w-96 h-96 bg-[#FDE047] rounded-full blur-[150px] opacity-20" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          >
            ...
            <span className="text-sm text-[#FDE047] font-semibold">Google's ML Platform</span>
          </motion.div>
              ...
              <div className="group relative h-full p-6 rounded-2xl bg-gradient-to-br from-[#1E293B] to-[#0F172A] border-2 border-[#4F46E5]/50 backdrop-blur-sm hover:border-[#FDE047]/50 transition-all duration-300 hover:shadow-[0_0_50px_rgba(79,70,229,0.3)]">
                ...
                <ResponsiveContainer width="100%" height={200}>
                  <BarChart data={inferenceData}>
                    ...
                    />
                    <Bar dataKey="time" fill="#FDE047" radius={[8, 8, 0, 0]} />
                  </BarChart>
                </ResponsiveContainer>
                
                <div className="mt-4 text-center">
                  <div className="text-3xl font-bold text-[#FDE047]">35ms</div>
        ...
        >
          <div className="relative p-10 rounded-2xl bg-gradient-to-br from-[#1E293B] to-[#0F172A] border-2 border-[#4F46E5]/50 shadow-[0_0_50px_rgba(79,70,229,0.3)]">
            ...
            <div className="max-w-4xl mx-auto space-y-6 text-gray-300 text-lg leading-relaxed">
              <p>
                TensorFlow serves as the <span className="text-[#FDE047] font-semibold">core machine learning framework</span> behind 
              ...
              <p>
                Using TensorFlow's <span className="text-[#4F46E5] font-semibold">LSTM (Long Short-Term Memory)</span> architecture, 
              ...
              <p>
                ...
                <span className="text-[#FDE047] font-semibold"> 2.3 MB package</span> that runs efficiently on mobile devices, 
