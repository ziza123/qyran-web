...
export function PyTorchDetail({ onBack }: PyTorchDetailProps) {
  return (
    <div className="min-h-screen bg-[#0F172A] relative overflow-hidden">
      ...
      <div className="absolute bottom-0 right-1/3 w-96 h-96 bg-[#FDE047] rounded-full blur-[150px] opacity-20" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          >
            ...
            <span className="text-sm text-[#FDE047] font-semibold">Research-Grade Framework</span>
          </motion.div>
              ...
              <div className="group relative h-full p-6 rounded-2xl bg-gradient-to-br from-[#1E293B] to-[#0F172A] border-2 border-[#4F46E5]/50 backdrop-blur-sm hover:border-[#FDE047]/50 transition-all duration-300 hover:shadow-[0_0_50px_rgba(79,70,229,0.3)]">
                ...
                <ResponsiveContainer width="100%" height={200}>
                  <LineChart data={trainingData}>
                    ...
                    />
                    <Line type="monotone" dataKey="train_loss" stroke="#4F46E5" strokeWidth={3} dot={{ fill: '#4F46E5', r: 4 }} name="Training" />
                    <Line type="monotone" dataKey="val_loss" stroke="#EE4C2C" strokeWidth={3} dot={{ fill: '#EE4C2C', r: 4 }} name="Validation" />
                  </LineChart>
                </ResponsiveContainer>
                
                <div className="mt-4 text-center">
                  <div className="text-3xl font-bold text-[#FDE047]">0.25</div>
              ...
              <div className="group relative h-full p-6 rounded-2xl bg-gradient-to-br from-[#1E293B] to-[#0F172A] border-2 border-[#4F46E5]/50 backdrop-blur-sm hover:border-[#FDE047]/50 transition-all duration-300 hover:shadow-[0_0_50px_rgba(79,70,229,0.3)]">
                ...
                <ResponsiveContainer width="100%" height={200}>
                  <AreaChart data={learningRateData}>
                    ...
                    />
                    <Area type="monotone" dataKey="lr" stroke="#FDE047" strokeWidth={2} fillOpacity={1} fill="url(#colorLR)" />
                  </AreaChart>
                </ResponsiveContainer>
                
                <div className="mt-4 text-center">
                  <div className="text-3xl font-bold text-[#FDE047]">Cosine</div>
        ...
        >
          <div className="relative p-10 rounded-2xl bg-gradient-to-br from-[#1E293B] to-[#0F172A] border-2 border-[#4F46E5]/50 shadow-[0_0_50px_rgba(79,70,229,0.3)]">
            ...
            <div className="max-w-4xl mx-auto space-y-6 text-gray-300 text-lg leading-relaxed">
              <p>
                PyTorch is Qyran's <span className="text-[#FDE047] font-semibold">primary research platform</span>, enabling our 
              ...
              <p>
                Our custom <span className="text-[#4F46E5] font-semibold">3D-CNN + LSTM hybrid architecture</span>, developed 
              ...
              <p>
                ...
                to sign language recognition, achieving <span className="text-[#FDE047] font-semibold">90% faster convergence</span> and 
