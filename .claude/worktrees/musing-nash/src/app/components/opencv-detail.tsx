...
export function OpenCVDetail({ onBack }: OpenCVDetailProps) {
  return (
    <div className="min-h-screen bg-[#0F172A] relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-1/3 w-96 h-96 bg-[#FDE047] rounded-full blur-[150px] opacity-20" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          >
            ...
            <span className="text-sm text-[#FDE047] font-semibold">Computer Vision Library</span>
          </motion.div>
            ...
            >
              <div className="group relative h-full p-6 rounded-2xl bg-gradient-to-br from-[#1E293B] to-[#0F172A] border-2 border-[#4F46E5]/50 backdrop-blur-sm hover:border-[#FDE047]/50 transition-all duration-300 hover:shadow-[0_0_50px_rgba(79,70,229,0.3)]">
                ...
                <div className="mt-4 text-center">
                  <div className="text-3xl font-bold text-[#FDE047]">17.7ms</div>
              ...
              <div className="group relative h-full p-6 rounded-2xl bg-gradient-to-br from-[#1E293B] to-[#0F172A] border-2 border-[#4F46E5]/50 backdrop-blur-sm hover:border-[#FDE047]/50 transition-all duration-300 hover:shadow-[0_0_50px_rgba(79,70,229,0.3)]">
                ...
                <ResponsiveContainer width="100%" height={200}>
                  <LineChart data={frameRateData}>
                    ...
                    />
                    <Line type="monotone" dataKey="fps" stroke="#FDE047" strokeWidth={3} dot={{ fill: '#FDE047', r: 5 }} />
                  </LineChart>
                </ResponsiveContainer>
                
                <div className="mt-4 text-center">
                  <div className="text-3xl font-bold text-[#FDE047]">60 FPS</div>
        ...
        >
          <div className="relative p-10 rounded-2xl bg-gradient-to-br from-[#1E293B] to-[#0F172A] border-2 border-[#4F46E5]/50 shadow-[0_0_50px_rgba(79,70,229,0.3)]">
            ...
            <div className="max-w-4xl mx-auto space-y-6 text-gray-300 text-lg leading-relaxed">
              <p>
                OpenCV serves as the <span className="text-[#FDE047] font-semibold">critical preprocessing layer</span> in 
              ...
              <p>
                Through advanced techniques like <span className="text-[#4F46E5] font-semibold">bilateral filtering</span> and 
                <span className="text-[#4F46E5] font-semibold"> CLAHE (Contrast Limited Adaptive Histogram Equalization)</span>, 
              ...
              <p>
                ...
                <span className="text-[#FDE047] font-semibold"> 18 milliseconds</span>, maintaining real-time performance while 
